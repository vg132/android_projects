package com.vgsoftware.android.feeddroid.service;

import java.util.List;
import java.util.concurrent.ScheduledThreadPoolExecutor;
import java.util.concurrent.TimeUnit;

import com.vgsoftware.android.feeddroid.FeedSync;
import com.vgsoftware.android.feeddroid.FeedSync.OnFeedSyncFinishedListener;
import com.vgsoftware.android.feeddroid.LogManager;
import com.vgsoftware.android.feeddroid.R;
import com.vgsoftware.android.feeddroid.Settings;
...
import com.vgsoftware.android.feeddroid.ui.FeedDroid;
...
public class UpdateService extends Service implements OnFeedSyncFinishedListener, OnSharedPreferenceChangeListener
{
	...
	{
		LogManager.info("Destroy Service");
		super.onDestroy();
		if (_scheduler != null)
		{
			_scheduler.shutdown();
	...
	private void showNotification(int items)
	{
		...
		Intent notificationIntent = new Intent(this, FeedDroid.class);
	...
	private void setupUpdateScheduler()
	{
		try
		{
			LogManager.info("setup Update Scheduler");
			if (_scheduler != null)
			{
		...
		{
			LogManager.error("Exception when running update scheduler", ex);
		}
	}
}