 ...
 */
public abstract class OrmLiteBaseFragmentActivity<H extends OrmLiteSqliteOpenHelper> extends FragmentActivity
{
	private volatile H helper;
	private volatile boolean created = false;
	private volatile boolean destroyed = false;
	private static Logger logger = LoggerFactory.getLogger(OrmLiteBaseFragmentActivity.class);
	 ...
	 * instance. This should not be called directly by client code unless you know
	 * what you are doing. Use {@link #getHelper()} to get a helper instance. If
	 * you are managing your own helper creation, override this method to supply
	 * this activity with a helper instance.
	 * 
	 * <p>
	 ...
	 * You most likely will not need to call this directly since
	 * {@link #onDestroy()} does it for you.
	 * 
	 * <p>
	 * <b> NOTE: </b> If you override this method, you most likely will need to
