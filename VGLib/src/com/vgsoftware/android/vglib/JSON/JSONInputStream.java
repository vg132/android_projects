...
public class JSONInputStream extends InputStream
{
	 ...
	 * 
	 * @param is
	 *          Input stream that contains the JSON content
	 */
	 ...
	 * 
	 * @param json
	 *          Input string that contains the JSON content
	 */
	 ...
	 *           in case parsing error is occurred
	 * @return the instance of the object created from the stream content
	 */
	public final <T> T readObject(final Class<T> objClass)
		throws JSONStreamException
	{
	 ...
	 * @return the instance of the object created from the stream content
	 */
	public final <T> T readObject(final Class<T> objClass, final T initialObj)
		throws JSONStreamException
	{
		...
		for (Field field : fields)
		{
			...
			{
				Log.e("JSONInputStream", String.format("Failed to get field [%s] %s", field.getName(), e.toString()));
				continue;
			}
			catch (JSONException e)
			{
	 ...
	 * @param enc
	 *          the encoding, in case of null default encoding is used
	 * @return the string that represents stream's content
	 * @throws Exception
	 *           on error
	 */
	private static String readStreamTillEnd(final InputStream is, final String enc)
		throws Exception
	{
		...
		{
			Log.e("JSONInputStream", String.format("Can't create BufferedReader [%s]", e.toString()));
			throw e;
		}
