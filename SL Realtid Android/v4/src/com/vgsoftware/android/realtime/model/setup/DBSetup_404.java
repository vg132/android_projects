...
import com.vgsoftware.android.realtime.model.SiteFilter;
...
public class DBSetup_404
{
	public static void create(DatabaseHelper helper, SQLiteDatabase db, ConnectionSource connectionSource)
	{
		try
		{
			...
			TableUtils.createTableIfNotExists(connectionSource, SiteFilter.class);
	...
	public static void upgrade(DatabaseHelper helper, SQLiteDatabase db, ConnectionSource connectionSource)
	{
		...
		catch (Exception ex)
		{
			...
			DBSetup_404.create(helper, db, connectionSource);
		}
	}
}
