...
public class Inventory
{
	 ...
	 * just modifies the Inventory object locally and has no effect on the server!
	 * This is useful when you have an existing Inventory object which you know to
	 * be up to date, and you have just consumed an item successfully, which means
	 * that erasing its purchase data from the Inventory you already have is
